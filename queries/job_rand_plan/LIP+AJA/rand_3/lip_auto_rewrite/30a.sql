...
/*+
HashJoin(t mi mk cc mi_idx ci cct2 n it1 cct1 it2 k)
HashJoin(t mi mk cc mi_idx ci cct2 n it1 cct1 it2)
HashJoin(t mi mk cc mi_idx ci cct2 n it1 cct1)
HashJoin(t mi mk cc mi_idx ci cct2 n it1)
HashJoin(t mi mk cc mi_idx ci cct2 n)
HashJoin(t mi mk cc mi_idx ci cct2)
HashJoin(t mi mk cc mi_idx ci)
HashJoin(t mi mk cc mi_idx)
HashJoin(t mi mk cc)
HashJoin(t mi mk)
HashJoin(t mi)
SeqScan(t)
...
SeqScan(it2)
SeqScan(k)
Leading((((((((((((t mi) mk) cc) mi_idx) ci) cct2) n) it1) cct1) it2) k))*/
