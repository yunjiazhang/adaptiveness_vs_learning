...
/*+
HashJoin(cc t cct2 mi_idx ci it2 mk n kt cct1 chn k)
HashJoin(cc t cct2 mi_idx ci it2 mk n kt cct1 chn)
HashJoin(cc t cct2 mi_idx ci it2 mk n kt cct1)
HashJoin(cc t cct2 mi_idx ci it2 mk n kt)
HashJoin(cc t cct2 mi_idx ci it2 mk n)
HashJoin(cc t cct2 mi_idx ci it2 mk)
HashJoin(cc t cct2 mi_idx ci it2)
HashJoin(cc t cct2 mi_idx ci)
HashJoin(cc t cct2 mi_idx)
HashJoin(cc t cct2)
HashJoin(cc t)
SeqScan(cc)
SeqScan(t)
...
SeqScan(chn)
SeqScan(k)
Leading((((((((((((cc t) cct2) mi_idx) ci) it2) mk) n) kt) cct1) chn) k))*/
