...
/*+
NestLoop(mi mk it t k ci mc rt an n chn cn)
NestLoop(mi mk it t k ci mc rt an n chn)
NestLoop(mi mk it t k ci mc rt an n)
NestLoop(mi mk it t k ci mc rt an)
NestLoop(mi mk it t k ci mc rt)
NestLoop(mi mk it t k ci mc)
NestLoop(mi mk it t k ci)
NestLoop(mi mk it t k)
NestLoop(mi mk it t)
NestLoop(mi mk it)
NestLoop(mi mk)
SeqScan(mi)
