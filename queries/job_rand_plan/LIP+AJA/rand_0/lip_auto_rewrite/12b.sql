...
/*+
NestLoop(mi mc ct mi_idx t it2 it1 cn)
NestLoop(mi mc ct mi_idx t it2 it1)
NestLoop(mi mc ct mi_idx t it2)
NestLoop(mi mc ct mi_idx t)
NestLoop(mi mc ct mi_idx)
NestLoop(mi mc ct)
NestLoop(mi mc)
SeqScan(mi)
IndexScan(mc)
...
IndexScan(it1)
IndexScan(cn)
Leading((((((((mi mc) ct) mi_idx) t) it2) it1) cn))*/
