...
/*+
NestLoop(cc cct2 mk t ci cct1 kt k mi_idx chn n it2)
NestLoop(cc cct2 mk t ci cct1 kt k mi_idx chn n)
NestLoop(cc cct2 mk t ci cct1 kt k mi_idx chn)
NestLoop(cc cct2 mk t ci cct1 kt k mi_idx)
NestLoop(cc cct2 mk t ci cct1 kt k)
NestLoop(cc cct2 mk t ci cct1 kt)
NestLoop(cc cct2 mk t ci cct1)
NestLoop(cc cct2 mk t ci)
NestLoop(cc cct2 mk t)
NestLoop(cc cct2 mk)
NestLoop(cc cct2)
SeqScan(cc)
IndexScan(cct2)
...
IndexScan(n)
IndexScan(it2)
Leading((((((((((((cc cct2) mk) t) ci) cct1) kt) k) mi_idx) chn) n) it2))*/
