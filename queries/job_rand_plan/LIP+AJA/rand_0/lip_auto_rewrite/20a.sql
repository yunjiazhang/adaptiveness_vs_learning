...
/*+
NestLoop(t kt cc cct2 mk cct1 ci n chn k)
NestLoop(t kt cc cct2 mk cct1 ci n chn)
NestLoop(t kt cc cct2 mk cct1 ci n)
NestLoop(t kt cc cct2 mk cct1 ci)
NestLoop(t kt cc cct2 mk cct1)
NestLoop(t kt cc cct2 mk)
NestLoop(t kt cc cct2)
HashJoin(t kt cc)
HashJoin(t kt)
SeqScan(t)
SeqScan(kt)
...
IndexScan(chn)
IndexScan(k)
Leading((((((((((t kt) cc) cct2) mk) cct1) ci) n) chn) k))*/
