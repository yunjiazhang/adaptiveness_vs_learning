...
/*+
NestLoop(ci chn n t mi_idx mk cc k cct2 kt cct1 it2)
NestLoop(ci chn n t mi_idx mk cc k cct2 kt cct1)
NestLoop(ci chn n t mi_idx mk cc k cct2 kt)
NestLoop(ci chn n t mi_idx mk cc k cct2)
NestLoop(ci chn n t mi_idx mk cc k)
NestLoop(ci chn n t mi_idx mk cc)
NestLoop(ci chn n t mi_idx mk)
NestLoop(ci chn n t mi_idx)
NestLoop(ci chn n t)
NestLoop(ci chn n)
NestLoop(ci chn)
SeqScan(ci)
