...
/*+
NestLoop(mi mk it1 mc t k ct at cn)
NestLoop(mi mk it1 mc t k ct at)
NestLoop(mi mk it1 mc t k ct)
NestLoop(mi mk it1 mc t k)
NestLoop(mi mk it1 mc t)
NestLoop(mi mk it1 mc)
NestLoop(mi mk it1)
NestLoop(mi mk)
SeqScan(mi)
IndexScan(mk)
...
IndexScan(at)
IndexScan(cn)
Leading(((((((((mi mk) it1) mc) t) k) ct) at) cn))*/
...
(
	...
	WHERE pg_lip_bloom_probe(3, at.movie_id)
) AS at ,
company_name AS cn ,
company_type AS ct ,
info_type AS it1 ,
