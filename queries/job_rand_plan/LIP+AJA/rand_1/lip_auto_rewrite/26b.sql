...
/*+
NestLoop(t ci cc chn cct1 cct2 mi_idx n mk kt it2 k)
NestLoop(t ci cc chn cct1 cct2 mi_idx n mk kt it2)
NestLoop(t ci cc chn cct1 cct2 mi_idx n mk kt)
NestLoop(t ci cc chn cct1 cct2 mi_idx n mk)
NestLoop(t ci cc chn cct1 cct2 mi_idx n)
NestLoop(t ci cc chn cct1 cct2 mi_idx)
NestLoop(t ci cc chn cct1 cct2)
NestLoop(t ci cc chn cct1)
NestLoop(t ci cc chn)
NestLoop(t ci cc)
NestLoop(t ci)
SeqScan(t)
IndexScan(ci)
