...
/*+
NestLoop(t mi_idx mi mc it1 it2 cn ct)
NestLoop(t mi_idx mi mc it1 it2 cn)
NestLoop(t mi_idx mi mc it1 it2)
NestLoop(t mi_idx mi mc it1)
NestLoop(t mi_idx mi mc)
