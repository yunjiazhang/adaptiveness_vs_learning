...
/*+
NestLoop(mi it1 mk t mi_idx cc ci n cct2 k it2 cct1)
NestLoop(mi it1 mk t mi_idx cc ci n cct2 k it2)
NestLoop(mi it1 mk t mi_idx cc ci n cct2 k)
NestLoop(mi it1 mk t mi_idx cc ci n cct2)
NestLoop(mi it1 mk t mi_idx cc ci n)
NestLoop(mi it1 mk t mi_idx cc ci)
NestLoop(mi it1 mk t mi_idx cc)
NestLoop(mi it1 mk t mi_idx)
NestLoop(mi it1 mk t)
NestLoop(mi it1 mk)
NestLoop(mi it1)
SeqScan(mi)
IndexScan(it1)
