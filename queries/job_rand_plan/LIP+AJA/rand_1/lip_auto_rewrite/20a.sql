...
/*+
NestLoop(ci chn cc cct2 mk cct1 t n k kt)
NestLoop(ci chn cc cct2 mk cct1 t n k)
NestLoop(ci chn cc cct2 mk cct1 t n)
NestLoop(ci chn cc cct2 mk cct1 t)
NestLoop(ci chn cc cct2 mk cct1)
NestLoop(ci chn cc cct2 mk)
NestLoop(ci chn cc cct2)
NestLoop(ci chn cc)
NestLoop(ci chn)
SeqScan(ci)
IndexScan(chn)
...
IndexScan(k)
IndexScan(kt)
Leading((((((((((ci chn) cc) cct2) mk) cct1) t) n) k) kt))*/
