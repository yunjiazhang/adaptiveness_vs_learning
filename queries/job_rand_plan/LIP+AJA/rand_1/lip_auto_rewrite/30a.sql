...
/*+
NestLoop(mi ci it1 t cc mi_idx mk it2 n cct1 cct2 k)
NestLoop(mi ci it1 t cc mi_idx mk it2 n cct1 cct2)
NestLoop(mi ci it1 t cc mi_idx mk it2 n cct1)
NestLoop(mi ci it1 t cc mi_idx mk it2 n)
NestLoop(mi ci it1 t cc mi_idx mk it2)
NestLoop(mi ci it1 t cc mi_idx mk)
NestLoop(mi ci it1 t cc mi_idx)
NestLoop(mi ci it1 t cc)
NestLoop(mi ci it1 t)
NestLoop(mi ci it1)
NestLoop(mi ci)
SeqScan(mi)
IndexScan(ci)
...
IndexScan(cct2)
IndexScan(k)
Leading((((((((((((mi ci) it1) t) cc) mi_idx) mk) it2) n) cct1) cct2) k))*/
