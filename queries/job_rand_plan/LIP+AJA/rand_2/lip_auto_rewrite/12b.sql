...
/*+
NestLoop(mc cn mi_idx t it2 ct mi it1)
NestLoop(mc cn mi_idx t it2 ct mi)
NestLoop(mc cn mi_idx t it2 ct)
NestLoop(mc cn mi_idx t it2)
NestLoop(mc cn mi_idx t)
NestLoop(mc cn mi_idx)
NestLoop(mc cn)
SeqScan(mc)
IndexScan(cn)
IndexScan(mi_idx)
...
IndexScan(mi)
IndexScan(it1)
Leading((((((((mc cn) mi_idx) t) it2) ct) mi) it1))*/
...
(
	...
	WHERE pg_lip_bloom_probe(1, mc.company_type_id)
