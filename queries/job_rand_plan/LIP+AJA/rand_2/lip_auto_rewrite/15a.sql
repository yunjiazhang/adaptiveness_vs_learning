...
/*+
NestLoop(mi mc aka_t cn mk t k ct it1)
NestLoop(mi mc aka_t cn mk t k ct)
NestLoop(mi mc aka_t cn mk t k)
NestLoop(mi mc aka_t cn mk t)
NestLoop(mi mc aka_t cn mk)
NestLoop(mi mc aka_t cn)
NestLoop(mi mc aka_t)
NestLoop(mi mc)
SeqScan(mi)
IndexScan(mc)
IndexScan(aka_t)
...
IndexScan(ct)
IndexScan(it1)
Leading(((((((((mi mc) aka_t) cn) mk) t) k) ct) it1))*/
