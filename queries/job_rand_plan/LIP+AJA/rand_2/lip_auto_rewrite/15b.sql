...
/*+
NestLoop(t mc cn at mk k mi it1 ct)
NestLoop(t mc cn at mk k mi it1)
NestLoop(t mc cn at mk k mi)
NestLoop(t mc cn at mk k)
NestLoop(t mc cn at mk)
NestLoop(t mc cn at)
NestLoop(t mc cn)
NestLoop(t mc)
SeqScan(t)
...
IndexScan(it1)
IndexScan(ct)
Leading(((((((((t mc) cn) at) mk) k) mi) it1) ct))*/
