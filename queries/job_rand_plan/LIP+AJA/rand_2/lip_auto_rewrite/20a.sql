...
/*+
NestLoop(cc cct2 t mk ci kt n cct1 chn k)
NestLoop(cc cct2 t mk ci kt n cct1 chn)
NestLoop(cc cct2 t mk ci kt n cct1)
NestLoop(cc cct2 t mk ci kt n)
NestLoop(cc cct2 t mk ci kt)
NestLoop(cc cct2 t mk ci)
NestLoop(cc cct2 t mk)
NestLoop(cc cct2 t)
NestLoop(cc cct2)
SeqScan(cc)
IndexScan(cct2)
...
IndexScan(chn)
IndexScan(k)
Leading((((((((((cc cct2) t) mk) ci) kt) n) cct1) chn) k))*/
