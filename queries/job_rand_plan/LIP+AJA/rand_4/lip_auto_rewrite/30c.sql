...
/*+
HashJoin(mi mi_idx cc ci cct1 t mk k it1 n it2 cct2)
HashJoin(mi mi_idx cc ci cct1 t mk k it1 n it2)
HashJoin(mi mi_idx cc ci cct1 t mk k it1 n)
HashJoin(mi mi_idx cc ci cct1 t mk k it1)
HashJoin(mi mi_idx cc ci cct1 t mk k)
HashJoin(mi mi_idx cc ci cct1 t mk)
HashJoin(mi mi_idx cc ci cct1 t)
HashJoin(mi mi_idx cc ci cct1)
HashJoin(mi mi_idx cc ci)
HashJoin(mi mi_idx cc)
HashJoin(mi mi_idx)
SeqScan(mi)
SeqScan(mi_idx)
SeqScan(cc)
...
SeqScan(it2)
SeqScan(cct2)
Leading((((((((((((mi mi_idx) cc) ci) cct1) t) mk) k) it1) n) it2) cct2))*/
