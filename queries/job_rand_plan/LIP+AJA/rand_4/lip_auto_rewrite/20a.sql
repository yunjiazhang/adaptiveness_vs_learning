...
/*+
HashJoin(ci t cc kt n mk chn cct1 k cct2)
HashJoin(ci t cc kt n mk chn cct1 k)
HashJoin(ci t cc kt n mk chn cct1)
HashJoin(ci t cc kt n mk chn)
HashJoin(ci t cc kt n mk)
HashJoin(ci t cc kt n)
HashJoin(ci t cc kt)
HashJoin(ci t cc)
HashJoin(ci t)
SeqScan(ci)
...
SeqScan(k)
SeqScan(cct2)
Leading((((((((((ci t) cc) kt) n) mk) chn) cct1) k) cct2))*/
