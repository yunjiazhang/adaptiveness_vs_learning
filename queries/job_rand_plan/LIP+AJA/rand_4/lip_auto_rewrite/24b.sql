...
/*+
HashJoin(mi mk mc ci rt chn it t n k an cn)
HashJoin(mi mk mc ci rt chn it t n k an)
HashJoin(mi mk mc ci rt chn it t n k)
HashJoin(mi mk mc ci rt chn it t n)
HashJoin(mi mk mc ci rt chn it t)
HashJoin(mi mk mc ci rt chn it)
HashJoin(mi mk mc ci rt chn)
HashJoin(mi mk mc ci rt)
HashJoin(mi mk mc ci)
HashJoin(mi mk mc)
HashJoin(mi mk)
SeqScan(mi)
SeqScan(mk)
...
SeqScan(an)
SeqScan(cn)
Leading((((((((((((mi mk) mc) ci) rt) chn) it) t) n) k) an) cn))*/
