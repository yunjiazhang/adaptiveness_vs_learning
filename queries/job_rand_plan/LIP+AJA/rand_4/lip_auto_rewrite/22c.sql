...
/*+
HashJoin(mi mk mi_idx it2 mc t kt k cn ct it1)
HashJoin(mi mk mi_idx it2 mc t kt k cn ct)
HashJoin(mi mk mi_idx it2 mc t kt k cn)
HashJoin(mi mk mi_idx it2 mc t kt k)
HashJoin(mi mk mi_idx it2 mc t kt)
HashJoin(mi mk mi_idx it2 mc t)
HashJoin(mi mk mi_idx it2 mc)
HashJoin(mi mk mi_idx it2)
HashJoin(mi mk mi_idx)
HashJoin(mi mk)
SeqScan(mi)
SeqScan(mk)
SeqScan(mi_idx)
...
SeqScan(ct)
SeqScan(it1)
Leading(((((((((((mi mk) mi_idx) it2) mc) t) kt) k) cn) ct) it1))*/
