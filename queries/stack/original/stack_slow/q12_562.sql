...
AND (t1.name in ('abstract-algebra','calculus','command-line','definite-integrals','integration','number-theory','real-analysis','reference-request','sequences-and-series'))
