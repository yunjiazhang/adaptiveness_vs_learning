...
WHERE 
 ...
 AND (t1.name in ('abstract-algebra','calculus','combinatorics','command-line','elementary-number-theory','integration','linear-algebra','real-analysis','reference-request','soft-question')) 
 AND (q1.score >= 10) 
 AND (q1.score <= 1000) 
 AND (u1.upvotes >= 0) 
 AND (u1.upvotes <= 1) 
