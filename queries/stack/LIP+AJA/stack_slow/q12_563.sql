...
WHERE 
 ...
 AND (t1.name in ('c++11','caching','character-encoding','entity-framework-core','enums','firebase-realtime-database','forms','hashmap','list','pivot-table','powershell','struct','websocket')) 
 AND (q1.view_count >= 0) 
