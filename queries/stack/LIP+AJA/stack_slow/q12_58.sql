...
WHERE 
 ...
 AND (t1.name in ('android','codeigniter','django-admin','environment-variables','flask','google-visualization','highcharts','json','microsoft-excel-2010','networking','oracle','submit','timeout','web-services','wso2')) 
 AND (q1.score >= 0) 
 AND (q1.score <= 0) 
 AND (u1.downvotes >= 10) 
