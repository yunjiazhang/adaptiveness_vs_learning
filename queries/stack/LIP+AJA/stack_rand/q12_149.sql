...
WHERE 
 ...
 AND (t1.name in ('c++builder','combinations','datetimepicker','element','facebook-php-sdk','firebird','joptionpane','procedure','racket','reactive-programming','rgb','ubuntu-16.04','uri','wmi')) 
 AND (q1.score >= 0) 
 AND (q1.score <= 0) 
