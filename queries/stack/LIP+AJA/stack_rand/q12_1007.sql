...
WHERE 
 ...
 AND (s.site_name in ('android','judaism','rpg','sharepoint','webmasters')) 
 AND (t1.name in ('2010','dnd-3.5e','gm-techniques','javascript','sharepoint-designer','sharepoint-enterprise','sharepoint-server')) 
