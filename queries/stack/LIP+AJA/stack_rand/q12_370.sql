...
WHERE 
 ...
 AND (t1.name in ('arch-linux','bing-maps','classcastexception','cpan','data-annotations','drawable','extern','mouselistener','nsmanagedobjectcontext','office-js','repeat','surfaceview','vlookup')) 
