...
WHERE 
 ...
 AND (s.site_name in ('blender','ell','money','travel','wordpress')) 
 AND (t1.name in ('customization','meaning-in-context','php','plugin-development','rendering','scripting','taxes','word-choice')) 
