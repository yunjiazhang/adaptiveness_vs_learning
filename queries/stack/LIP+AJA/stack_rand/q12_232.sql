...
WHERE 
 ...
 AND (t1.name in ('android-alertdialog','angularjs-ng-repeat','apache-pig','asp-classic','azure-cosmosdb','azure-functions','byte','docusignapi','enzyme','filtering','mdx','nosql','overriding','posix','responsive')) 
 AND (q1.view_count >= 0) 
