...
WHERE 
 ...
 AND (t1.name in ('algebra-precalculus','combinatorics','commutative-algebra','convergence','eigenvalues-eigenvectors','general-topology','limits','proof-verification','soft-question')) 
