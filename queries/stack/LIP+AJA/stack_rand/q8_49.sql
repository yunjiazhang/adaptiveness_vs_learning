...
/*+
NestLoop(site tag tq1 pl c1 q1 tq2 c2 q2)
NestLoop(site tag tq1 pl c1 q1 tq2 c2)
NestLoop(site tag tq1 pl c1 q1 tq2)
NestLoop(site tag tq1 pl c1 q1)
NestLoop(site tag tq1 pl c1)
NestLoop(site tag tq1 pl)
NestLoop(site tag tq1)
NestLoop(site tag)
IndexScan(tq1)
IndexScan(tq2)
SeqScan(site)
