...
/*+
HashJoin(mc mi it t cn ci n chn rt an)
HashJoin(mc mi it t cn ci n chn rt)
HashJoin(mc mi it t cn ci n chn)
HashJoin(mc mi it t cn ci n)
HashJoin(mc mi it t cn ci)
HashJoin(mc mi it t cn)
HashJoin(mc mi it t)
HashJoin(mc mi it)
HashJoin(mc mi)
SeqScan(mc)
...
SeqScan(rt)
SeqScan(an)
Leading((((((((((mc mi) it) t) cn) ci) n) chn) rt) an))*/
