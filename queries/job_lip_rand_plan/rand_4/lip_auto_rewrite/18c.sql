...
/*+
HashJoin(mi it1 mi_idx it2 ci n t)
HashJoin(mi it1 mi_idx it2 ci n)
HashJoin(mi it1 mi_idx it2 ci)
HashJoin(mi it1 mi_idx it2)
HashJoin(mi it1 mi_idx)
HashJoin(mi it1)
SeqScan(mi)
SeqScan(it1)
SeqScan(mi_idx)
...
SeqScan(n)
SeqScan(t)
Leading(((((((mi it1) mi_idx) it2) ci) n) t))*/
