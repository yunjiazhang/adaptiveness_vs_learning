...
/*+
NestLoop(t mc mi_idx ct mk cn mi kt k it2 it1)
NestLoop(t mc mi_idx ct mk cn mi kt k it2)
NestLoop(t mc mi_idx ct mk cn mi kt k)
NestLoop(t mc mi_idx ct mk cn mi kt)
NestLoop(t mc mi_idx ct mk cn mi)
NestLoop(t mc mi_idx ct mk cn)
NestLoop(t mc mi_idx ct mk)
NestLoop(t mc mi_idx ct)
NestLoop(t mc mi_idx)
NestLoop(t mc)
SeqScan(t)
IndexScan(mc)
IndexScan(mi_idx)
