...
/*+
NestLoop(mi t mc it ci rt cn n chn an)
NestLoop(mi t mc it ci rt cn n chn)
NestLoop(mi t mc it ci rt cn n)
NestLoop(mi t mc it ci rt cn)
NestLoop(mi t mc it ci rt)
NestLoop(mi t mc it ci)
NestLoop(mi t mc it)
NestLoop(mi t mc)
NestLoop(mi t)
SeqScan(mi)
