...
/*+
NestLoop(t mi at mc it1 mk cn ct k)
NestLoop(t mi at mc it1 mk cn ct)
NestLoop(t mi at mc it1 mk cn)
NestLoop(t mi at mc it1 mk)
NestLoop(t mi at mc it1)
NestLoop(t mi at mc)
NestLoop(t mi at)
NestLoop(t mi)
SeqScan(t)
...
IndexScan(ct)
IndexScan(k)
Leading(((((((((t mi) at) mc) it1) mk) cn) ct) k))*/
