...
/*+
NestLoop(mk t mi mc it1 mi_idx kt it2 ct k cn)
NestLoop(mk t mi mc it1 mi_idx kt it2 ct k)
NestLoop(mk t mi mc it1 mi_idx kt it2 ct)
NestLoop(mk t mi mc it1 mi_idx kt it2)
NestLoop(mk t mi mc it1 mi_idx kt)
NestLoop(mk t mi mc it1 mi_idx)
NestLoop(mk t mi mc it1)
NestLoop(mk t mi mc)
NestLoop(mk t mi)
NestLoop(mk t)
SeqScan(mk)
...
IndexScan(k)
IndexScan(cn)
Leading(((((((((((mk t) mi) mc) it1) mi_idx) kt) it2) ct) k) cn))*/
