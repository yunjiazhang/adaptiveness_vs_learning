...
/*+
NestLoop(mc aka_t mi ct mk t cn k it1)
NestLoop(mc aka_t mi ct mk t cn k)
NestLoop(mc aka_t mi ct mk t cn)
NestLoop(mc aka_t mi ct mk t)
NestLoop(mc aka_t mi ct mk)
NestLoop(mc aka_t mi ct)
NestLoop(mc aka_t mi)
NestLoop(mc aka_t)
IndexScan(mc)
SeqScan(aka_t)
IndexScan(mi)
...
IndexScan(k)
IndexScan(it1)
Leading(((((((((aka_t mc) mi) ct) mk) t) cn) k) it1))*/
...
(
	...
	WHERE pg_lip_bloom_probe(3, aka_t.movie_id)
