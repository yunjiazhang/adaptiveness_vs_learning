...
/*+
NestLoop(mi it1 ci mk t mi_idx k n it2)
NestLoop(mi it1 ci mk t mi_idx k n)
NestLoop(mi it1 ci mk t mi_idx k)
NestLoop(mi it1 ci mk t mi_idx)
NestLoop(mi it1 ci mk t)
NestLoop(mi it1 ci mk)
NestLoop(mi it1 ci)
NestLoop(mi it1)
SeqScan(mi)
IndexScan(it1)
...
IndexScan(n)
IndexScan(it2)
Leading(((((((((mi it1) ci) mk) t) mi_idx) k) n) it2))*/
