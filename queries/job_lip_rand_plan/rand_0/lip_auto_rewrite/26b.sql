...
/*+
NestLoop(mi_idx t ci cc cct2 cct1 mk it2 n chn kt k)
NestLoop(mi_idx t ci cc cct2 cct1 mk it2 n chn kt)
NestLoop(mi_idx t ci cc cct2 cct1 mk it2 n chn)
NestLoop(mi_idx t ci cc cct2 cct1 mk it2 n)
NestLoop(mi_idx t ci cc cct2 cct1 mk it2)
NestLoop(mi_idx t ci cc cct2 cct1 mk)
NestLoop(mi_idx t ci cc cct2 cct1)
NestLoop(mi_idx t ci cc cct2)
NestLoop(mi_idx t ci cc)
NestLoop(mi_idx t ci)
NestLoop(mi_idx t)
SeqScan(mi_idx)
IndexScan(t)
IndexScan(ci)
