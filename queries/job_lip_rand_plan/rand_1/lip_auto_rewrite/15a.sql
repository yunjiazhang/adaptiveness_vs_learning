...
/*+
NestLoop(mi mk k t aka_t mc ct cn it1)
NestLoop(mi mk k t aka_t mc ct cn)
NestLoop(mi mk k t aka_t mc ct)
NestLoop(mi mk k t aka_t mc)
NestLoop(mi mk k t aka_t)
NestLoop(mi mk k t)
NestLoop(mi mk k)
NestLoop(mi mk)
SeqScan(mi)
...
IndexScan(cn)
IndexScan(it1)
Leading(((((((((mi mk) k) t) aka_t) mc) ct) cn) it1))*/
