...
/*+
HashJoin(t mi mi_idx mk mc it2 cn ct k it1 kt)
HashJoin(t mi mi_idx mk mc it2 cn ct k it1)
HashJoin(t mi mi_idx mk mc it2 cn ct k)
HashJoin(t mi mi_idx mk mc it2 cn ct)
HashJoin(t mi mi_idx mk mc it2 cn)
HashJoin(t mi mi_idx mk mc it2)
HashJoin(t mi mi_idx mk mc)
HashJoin(t mi mi_idx mk)
HashJoin(t mi mi_idx)
HashJoin(t mi)
SeqScan(t)
SeqScan(mi)
SeqScan(mi_idx)
...
SeqScan(it1)
SeqScan(kt)
Leading(((((((((((t mi) mi_idx) mk) mc) it2) cn) ct) k) it1) kt))*/
