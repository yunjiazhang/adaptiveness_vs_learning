...
/*+
NestLoop(t mk mi mc mi_idx it1 kt it2 ct k cn)
NestLoop(t mk mi mc mi_idx it1 kt it2 ct k)
NestLoop(t mk mi mc mi_idx it1 kt it2 ct)
NestLoop(t mk mi mc mi_idx it1 kt it2)
NestLoop(t mk mi mc mi_idx it1 kt)
NestLoop(t mk mi mc mi_idx it1)
NestLoop(t mk mi mc mi_idx)
NestLoop(t mk mi mc)
NestLoop(t mk mi)
HashJoin(t mk)
SeqScan(t)
