...
/*+
NestLoop(ci cc mk t mi_idx kt cct2 cct1 n chn k it2)
NestLoop(ci cc mk t mi_idx kt cct2 cct1 n chn k)
NestLoop(ci cc mk t mi_idx kt cct2 cct1 n chn)
NestLoop(ci cc mk t mi_idx kt cct2 cct1 n)
NestLoop(ci cc mk t mi_idx kt cct2 cct1)
NestLoop(ci cc mk t mi_idx kt cct2)
NestLoop(ci cc mk t mi_idx kt)
NestLoop(ci cc mk t mi_idx)
NestLoop(ci cc mk t)
HashJoin(ci cc mk)
HashJoin(ci cc)
SeqScan(ci)
