...
/*+
NestLoop(mk cc t mi_idx ci mi cct1 cct2 k it2 n it1)
NestLoop(mk cc t mi_idx ci mi cct1 cct2 k it2 n)
NestLoop(mk cc t mi_idx ci mi cct1 cct2 k it2)
NestLoop(mk cc t mi_idx ci mi cct1 cct2 k)
NestLoop(mk cc t mi_idx ci mi cct1 cct2)
NestLoop(mk cc t mi_idx ci mi cct1)
NestLoop(mk cc t mi_idx ci mi)
NestLoop(mk cc t mi_idx ci)
NestLoop(mk cc t mi_idx)
NestLoop(mk cc t)
NestLoop(mk cc)
SeqScan(mk)
IndexScan(cc)
...
IndexScan(n)
IndexScan(it1)
Leading((((((((((((mk cc) t) mi_idx) ci) mi) cct1) cct2) k) it2) n) it1))*/
...
(
	...
	-- WHERE pg_lip_bloom_probe(7, ci.person_id)
