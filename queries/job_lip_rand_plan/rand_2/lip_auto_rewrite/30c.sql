...
/*+
NestLoop(mi_idx cc cct2 mk mi it2 t ci it1 k cct1 n)
NestLoop(mi_idx cc cct2 mk mi it2 t ci it1 k cct1)
NestLoop(mi_idx cc cct2 mk mi it2 t ci it1 k)
NestLoop(mi_idx cc cct2 mk mi it2 t ci it1)
NestLoop(mi_idx cc cct2 mk mi it2 t ci)
NestLoop(mi_idx cc cct2 mk mi it2 t)
NestLoop(mi_idx cc cct2 mk mi it2)
NestLoop(mi_idx cc cct2 mk mi)
HashJoin(mi_idx cc cct2 mk)
HashJoin(mi_idx cc cct2)
HashJoin(mi_idx cc)
SeqScan(mi_idx)
SeqScan(cc)
SeqScan(cct2)
...
IndexScan(cct1)
IndexScan(n)
Leading((((((((((((mi_idx cc) cct2) mk) mi) it2) t) ci) it1) k) cct1) n))*/
