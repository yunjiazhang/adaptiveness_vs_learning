...
/*+
NestLoop(mi ci mk mc n t k cn an rt it chn)
NestLoop(mi ci mk mc n t k cn an rt it)
NestLoop(mi ci mk mc n t k cn an rt)
NestLoop(mi ci mk mc n t k cn an)
NestLoop(mi ci mk mc n t k cn)
NestLoop(mi ci mk mc n t k)
NestLoop(mi ci mk mc n t)
NestLoop(mi ci mk mc n)
NestLoop(mi ci mk mc)
NestLoop(mi ci mk)
NestLoop(mi ci)
SeqScan(mi)
IndexScan(ci)
...
IndexScan(it)
IndexScan(chn)
Leading((((((((((((mi ci) mk) mc) n) t) k) cn) an) rt) it) chn))*/
