/*+ NestLoop(k mk mi_idx it2 mc cn t ci mi it1 n)
 NestLoop(k mk mi_idx it2 mc cn t ci mi it1)
 NestLoop(k mk mi_idx it2 mc cn t ci mi)
 ...
 SeqScan(it1)
 IndexScan(n)
 Leading(((((((((((k mk) mi_idx) it2) mc) cn) t) ci) mi) it1) n)) */
