...
-- SELECT sum(pg_lip_bloom_add(2, id)) FROM info_type AS it WHERE it.info ='rating';
SELECT sum(pg_lip_bloom_add(3, id)) FROM info_type AS it2 WHERE it2.info ='release dates';
